...
useEffect(()=>{
const unsubscribe = dp.collection("chats").onSnapshot(snapshot => (
...
return unsubscribe;
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      title: "Chat App",
      headerStyle: { backgroudColor: "white" },
      ...
      headerRight: ()=>(
        <View style={{
            ...
            <TouchableOpacity onPress={() => navigation.navigate("AddChat")} activeOpacity={0.6}>
